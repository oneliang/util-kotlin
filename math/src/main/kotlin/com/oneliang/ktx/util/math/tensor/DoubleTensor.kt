...
fun Array<Array<Array<Double>>>.innerOperate(bTensor: Array<Array<Array<Double>>>, depthOffset: Int = 0, rowOffset: Int = 0, columnOffset: Int = 0, operate: (aValue: Double, bValue: Double) -> Double): Double {
...
fun Array<Array<Array<Double>>>.innerProduct(bMatrix: Array<Array<Array<Double>>>, depthOffset: Int = 0, rowOffset: Int = 0, columnOffset: Int = 0): Double = this.innerOperate(bMatrix, depthOffset, rowOffset, columnOffset) { aValue: Double, bValue: Double -> aValue * bValue }