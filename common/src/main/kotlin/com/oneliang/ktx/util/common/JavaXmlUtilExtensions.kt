...
fun InputStream.toJavaXmlDocument(): Document = JavaXmlUtil.parse(this)

fun File.toJavaXmlDocument(): Document = JavaXmlUtil.parse(this)

fun ByteArray.toJavaXmlDocument(): Document = ByteArrayInputStream(this).toJavaXmlDocument()