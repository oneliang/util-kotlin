...
object JsonWebToken {
    ...
    fun create(header: String, body: String, signature: String): String {
        ...
        return headerBase64UrlEncode + Constants.Symbol.DOT_CHAR + bodyBase64UrlEncode + Constants.Symbol.DOT_CHAR + if (signature.isBlank()) {
